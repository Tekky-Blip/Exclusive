...
local Window = Rayfield:CreateWindow({
    Name = "Kalyptic Hub By FutureTek",
    Icon = 0,
...
if L.vhsows then
	local debugtab = Window:CreateTab("Debug", 7743876054)
		...
		debugtab:CreateSection("Target")
			...
			local debugl = debugtab:CreateLabel("Welcome To Kalyptic Hub")
...
local usertab = Window:CreateTab("Functions", 7743876054)
...
local grabtab = Window:CreateTab("Grabs & Lines", 7733954884)
...
local blobtab = Window:CreateTab("Blobman", 7733916988)
...
local lagtab = Window:CreateTab("Lag Server", 7733765045)
...
local killtab = Window:CreateTab("Players", 7733674079)
...
local liststab = Window:CreateTab("Player Lists", 7733674079)
...
local toytab = Window:CreateTab("Toys", 7733946818)
...
local bindtab = Window:CreateTab("Keybinds", 7733799901)
...
local visualtab = Window:CreateTab("Visuals", 7733774602)
